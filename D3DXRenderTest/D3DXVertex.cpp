...
DWORD Vertex::m_fvf = D3DFVF_XYZ | D3DFVF_DIFFUSE | D3DFVF_NORMAL | D3DFVF_TEX0;
DWORD Vertex_Point::m_fvf = D3DFVF_XYZ | D3DFVF_DIFFUSE | D3DFVF_NORMAL | D3DFVF_TEX0 | D3DFVF_PSIZE;
...
{
	{
		D3DVERTEXELEMENT9 ele[] = {
			...
			{ 0, 4 + sizeof(Vec3) + sizeof(Color4f) + sizeof(Vec3), D3DDECLTYPE_FLOAT2, D3DDECLMETHOD_DEFAULT, D3DDECLUSAGE_TEXCOORD, 0, },
			D3DDECL_END()
		};
...

	{
		D3DVERTEXELEMENT9 ele[] = {
			...
			{ 0, 4 + sizeof(Vec3) + sizeof(Color4f), D3DDECLTYPE_FLOAT3, D3DDECLMETHOD_DEFAULT, D3DDECLUSAGE_NORMAL, 0, },
			{ 0, 4 + sizeof(Vec3) + sizeof(Color4f) + sizeof(Vec3), D3DDECLTYPE_FLOAT2, D3DDECLMETHOD_DEFAULT, D3DDECLUSAGE_TEXCOORD, 0, },
			{ 0, 4 + sizeof(Vec3) + sizeof(Color4f) + sizeof(Vec3) + sizeof(Vec2), D3DDECLTYPE_FLOAT1, D3DDECLMETHOD_DEFAULT, D3DDECLUSAGE_PSIZE, 0, },
			D3DDECL_END()
		};
